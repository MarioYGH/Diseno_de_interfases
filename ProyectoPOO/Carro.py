...
class Scene:
    ...
    def update_scene(self):
        ...
        # Dibujar nubes si no es de noche
        if self.time_of_day != 'night':
            self.draw_clouds()
    ...
    def draw_buildings(self):
        class Buildings:
            ...
            def draw(self):
                ...
                # columna izquierda
                cv.rectangle(self.img, (self.position + 37 - 10, 200 + 37 - 10),
                             (self.position + 37 + 10, 200 + 37 + 10), (255, 255, 255), -1)
                cv.rectangle(self.img, (self.position + 37 - 10, 350 - 37 - 10),
                             (self.position + 37 + 10, 350 - 37 + 10), (255, 255, 255), -1)
                # columna derecha
                cv.rectangle(self.img, (self.position + 150 - 37 - 10, 200 + 37 - 10),
                             (self.position + 150 - 37 + 10, 200 + 37 + 10), (255, 255, 255), -1)
                cv.rectangle(self.img, (self.position + 150 - 37 - 10, 350 - 37 - 10),
                             (self.position + 150 - 37 + 10, 350 - 37 + 10), (255, 255, 255), -1)
                if self.height == 2:
                    cv.rectangle(self.img, (self.position + 37 - 10, 200 - 75 + 37 - 10),
                                 (self.position + 37 + 10, 200 - 75 + 37 + 10), (255, 255, 255), -1)
                    cv.rectangle(self.img, (self.position + 150 - 37 - 10, 200 - 75 + 37 - 10),
                                 (self.position + 150 - 37 + 10, 200 - 75 + 37 + 10), (255, 255, 255), -1)
    ...
    def draw_clouds(self):
        cloud_count = rand.randint(3, 6)  # Número aleatorio de nubes
        for _ in range(cloud_count):
            x = rand.randint(0, self.img.shape[1] - 200)
            y = rand.randint(0, self.img.shape[0] // 2)
            cloud_width = rand.randint(100, 200)
            cloud_height = rand.randint(30, 60)
            color = (255, 255, 255)  # Color blanco para las nubes

            # Dibujar la nube como una serie de elipses
            for _ in range(rand.randint(3, 6)):  # Variar el número de elipses para cada nube
                ellipse_x = x + rand.randint(-30, 30)
                ellipse_y = y + rand.randint(-20, 20)
                cv.ellipse(self.img, (ellipse_x, ellipse_y), (cloud_width // 2, cloud_height // 2), 0, 0, 360, color, -1)
